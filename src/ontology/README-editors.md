...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/dosumis/pcl) for details.
 ...
 * https://github.com/dosumis/pcl/releases
 * https://github.com/dosumis/pcl/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/dosumis/pcl.svg?branch=master)](https://travis-ci.org/dosumis/pcl)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/dosumis](https://travis-ci.org/profile/dosumis)
 2. click the "Sync account" button
 3. Click the tick symbol next to pcl
