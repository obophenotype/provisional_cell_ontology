These notes are for the EDITORS of pcl
...
Make sure you have an ID range in the [idranges file](pcl-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [pcl-edit.owl](pcl-edit.owl)

** DO NOT EDIT pcl.obo OR pcl.owl in the top level directory **

[../../pcl.owl](../../pcl.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/provisional_cell_ontology) for details.
 ...
 * [pcl-idranges.owl](pcl-idranges.owl)
...
This generates derived files such as pcl.owl and pcl.obo and places
 ...
 * https://github.com/obophenotype/provisional_cell_ontology/releases
 * https://github.com/obophenotype/provisional_cell_ontology/releases/new
...
what is in the `owl:versionIRI` of the derived pcl.owl (`data-version` in
pcl.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/pcl.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/pcl/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/provisional_cell_ontology.svg?branch=master)](https://travis-ci.org/obophenotype/provisional_cell_ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to provisional_cell_ontology
