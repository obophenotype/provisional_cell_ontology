 ...
 * [pcl.yml](pcl.yml)
     * Determines how your purl.obolibrary.org/obo/pcl/ redirects will be handled
     ...
     * Paste in the contents of [pcl.yml](pcl.yml)
 ...
 * [pcl.md](pcl.md)
     ...
     * Paste in the contents of [pcl.md](pcl.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
